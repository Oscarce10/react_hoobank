...
const Hero = () => (
    <section id="home" className="flex md:flex-row flex-col">
        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
            ...
            <h1 className="font-poppins font-semibold ss:text-[68] text-[52px] text-white ss:leading-[100px] leading-[75px]">
                Payment Method.
            </h1>
        ...
        <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
            ...
            <div className="absolute z-[1] w-[80%] h-[80%] round-full bottom-0 white__gradient" />
